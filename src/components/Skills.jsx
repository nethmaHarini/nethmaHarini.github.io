  ...
  const managementSkills = [
    {
      ...
      description:
        "Structured roadmaps, milestone tracking, and timeline alignment.",
    },
    {
      title: "Risk Management",
      description:
        "Identifying bottlenecks early and implementing mitigation strategies.",
    },
    {
      title: "Stakeholder Communication",
      description:
        "Ensuring transparency and expectation alignment across teams.",
    },
  ];
  ...
  const leadershipSkills = [
    {
      title: "Agile & Scrum",
      description:
        "Streamlining workflows and delivering value through iterative processes.",
    },
    {
      title: "Team Leadership",
      description:
        "Empowering cross-functional teams to achieve high-performance outcomes.",
    },
    {
      title: "Resource Management",
      description:
        "Optimizing talent and budget allocation for maximum efficiency.",
    },
  ];
          ...
          <div className="relative z-10 space-y-16">
            <div className="text-center space-y-4 max-w-2xl mx-auto">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400">
                Strategic skills for leading complex initiatives and
