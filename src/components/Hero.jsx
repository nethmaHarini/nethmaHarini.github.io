    ...
    <section className="flex flex-col md:flex-row items-center gap-12 px-6 py-20 md:py-32">
      <div className="flex-1 space-y-8 order-2 md:order-1 text-center md:text-left">
        ...
        <div className="flex flex-wrap gap-4 justify-center md:justify-start">
          ...
          <button
            className="btn-lift px-8 py-4 border border-primary/50 text-primary font-bold rounded hover:bg-primary/5 transition-all"
      ...
      <div className="flex-1 flex justify-center order-1 md:order-2">
        <div className="relative group">
          ...
          {/* Circular Frame */}
          <div className="relative w-64 h-64 md:w-96 md:h-96 rounded-full border border-primary/20 dark:border-primary/40 p-2">
